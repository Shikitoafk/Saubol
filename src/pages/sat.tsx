    ...
    <Layout>
      <section className="hero-gradient py-16 text-primary-foreground">
        <div className="container text-center">
          <h1 className="text-4xl font-bold md:text-5xl">SAT Question Bank</h1>
          <p className="mx-auto mt-3 max-w-2xl text-lg opacity-90">
            Digital SAT practice questions with filters, timer mode, and explanations.
          </p>
        </div>
      </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                  SAT question bank with filters by section, category, and difficulty. Includes timer mode and detailed explanations.
                </p>
              </div>
            </div>
            <Button
