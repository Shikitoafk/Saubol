...
export default function RoadmapStageCard({ stage, isCompleted, isLocked, onComplete }: RoadmapStageProps) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={`glass-3d p-12 border-white/5 relative overflow-hidden transition-all ${
    ...
    >
      ...
      <div className="absolute -bottom-10 -right-10 text-[200px] font-black text-white/[0.02] italic select-none pointer-events-none">
        0{stage.stage}
      </div>
    </motion.div>
  );
